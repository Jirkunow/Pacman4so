		...
		if((BBP[i].ready && BBP[i].vivo) && !(BBP[i].checked)){
			...
			for(int j = 1; j < buff_size ; j++){
				if(i != j){
					if(BBP[i].x == BBP[j].x && BBP[i].y == BBP[j].y && BBP[j].vivo){
						...
						scriviLogBull(BBP[i].x,BBP[i].y,"Collisione tra proiettili !!",BBP[i].dir,BBP[i].id,i);
						scriviLogBull(BBP[j].x,BBP[j].y,"Collisione tra proiettili !!",BBP[j].dir,BBP[j].id,i);
			...
			for(int j = 0; j < numero_caramelline+1 ; j++){
				if(BBP[i].x == caramelline[j].y && BBP[i].y == caramelline[j].x){
					...
					scriviLogBull(BBP[i].x,BBP[i].y,"Caramellina colpita!!",BBP[i].dir,BBP[i].id,i);
			...
			if(BBP[i].x == posizioni[0].xn && BBP[i].y == posizioni[0].yn && BBP[i].vivo){
				...
				BBP[i].vivo = 0;
				BBP[i].t_vivo = 0;
				scriviLogBull(BBP[i].x,BBP[i].y,"Pacman colpito!!",BBP[i].dir,BBP[i].id,i);
			...
			for(int j = 1; j < 6 ; j++){
				if(BBP[i].x ==  BFC[j].xn && BBP[i].y == BFC[j].yn  && BBP[i].vivo){
					...
					scriviLogBull(BBP[i].x,BBP[i].y,"Fantasmino colpito!!",BBP[i].dir,BBP[i].id,i);
